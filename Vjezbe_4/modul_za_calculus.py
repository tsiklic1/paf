...
lista1 = calc.derivacija_2(kubna, a, b, 0.1, 0)
lista2 = calc.derivacija_2(kubna, a, b, 0.01, 0)
listaF = []
for i in lista1[0]:
    listaF.append(3*i**2 - 16*i)
...
lista1 = calc.derivacija_2(trigonometrijska, a, b, 0.1, 1)
lista2 = calc.derivacija_2(trigonometrijska, a, b, 0.01, 1)
listaF = []
for i in lista1[0]:
    listaF.append(math.cos(i))
