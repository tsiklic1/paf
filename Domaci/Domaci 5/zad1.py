...
pozitron = em.el_magn(promj, 1., 1., np.array((0.1, 0.1, 0.1)), np.array((0.,0.,0.)), np.array((0., 0., 1.)))
pozitron.trajectory_f()
fig = plt.figure()
ax = plt.axes(projection = "3d")
ax.plot3D(elektron2.listaX, elektron2.listaY, elektron2.listaZ)
ax.plot3D(pozitron.listaX, pozitron.listaY, pozitron.listaZ)
plt.show()